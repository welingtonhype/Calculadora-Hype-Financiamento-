      ...
      <div className="bg-white p-5 md:p-8 rounded-xl shadow-sm md:shadow-md">
        <div className="space-y-6 md:space-y-8">
          <div className="relative">
            <label htmlFor="rendaMensal" className="flex items-center gap-2 md:gap-2.5 text-sm md:text-base font-medium text-gray-800 mb-2 md:mb-3">
              <Wallet className="w-4 md:w-5 h-4 md:h-5 text-hype-green" />
              Renda mensal
            </label>
            <Input
              id="rendaMensal"
              ...
              className="w-full text-sm md:text-base py-4 md:py-6 px-3 md:px-4 border-gray-200 focus:border-hype-green focus:ring-hype-green transition-colors rounded-lg"
            />
          </div>

          <div className="relative">
            <label htmlFor="entrada" className="flex items-center gap-2 md:gap-2.5 text-sm md:text-base font-medium text-gray-800 mb-2 md:mb-3">
              <PiggyBank className="w-4 md:w-5 h-4 md:h-5 text-hype-green" />
              Valor de entrada
            </label>
            <Input
              id="entrada"
        ...
        <div className="flex flex-col gap-3 md:gap-4 mt-8 md:mt-10">
          <Button 
            ...
            className="w-full bg-hype-green hover:bg-hype-green/90 text-white py-5 md:py-6 text-sm md:text-base font-medium transition-colors duration-200 rounded-lg"
          >
          ...
          <Button 
            onClick={onVoltar}
            variant="outline"
            className="w-full flex items-center justify-center gap-2 py-5 md:py-6 text-sm md:text-base font-medium border-gray-200 hover:bg-gray-50 transition-colors duration-200 rounded-lg"
          >
